...
tput sgr0
echo
curl -sL https://github.com/milegroup/gasatad/raw/gh-pages/packages/GASATaD_1_2.app.tgz -o $TMPDIR/GASATaD_1_2.app.tgz
tar xfz $TMPDIR/GASATaD_1_2.app.tgz -C $TMPDIR
rm -rf /Applications/GASATaD.app
mv $TMPDIR/GASATaD.app /Applications
echo GASATaD ver. 1.2 has been added to the Applications folder
